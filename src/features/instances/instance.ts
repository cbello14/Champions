...
export class Instance {
	...
	constructor(b: Board = new Board(), n = 2, r: InstancePieceMap = new InstancePieceMap(), i: InstancePieceMap = new InstancePieceMap(), d: ReadonlyMap<instancePieceId, info> = new Map(), id?: string) {
