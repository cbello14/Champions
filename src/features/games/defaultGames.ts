...
import { bishop, king, knight, pawn, queen, rook } from '../pieces/defaultPieces';

import type { InstancePiece } from '@/types/instancePiece';
...
const basicGame: Game = new Game('basic', basic, instancePieceMap);
