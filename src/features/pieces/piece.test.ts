...
const moveB: move = {
	attributes: { type: moveMovementType.jump, reflection: "none", initialMove: "optional", capturing: "optional" },
...
describe("Piece", () => {
	...
	describe("removeMoveAt", () => {
		test("removes the move at the given index", () => {
			const piece = new Piece("p", { src: "", verified: false }, [moveA, moveB], ["direct", "no-capture"]);
