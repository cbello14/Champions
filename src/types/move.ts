...
type reflect = 'horizontal' | 'vertical' | 'horizontal-vertical' | undefined
...
export type { movementType, reflect, moveAttributes, cardinalDirection, diagonalDirection, direction, distance, movement, move }
