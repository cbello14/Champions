...
describe("calculateMovesRect", () => {
				...
				describe("Piece captures where it lands", () => {
					test("returns the landing square with capture when enemy is present", () => {
						const piece = new Piece(
							...
							[
								{
									attributes: { type: moveMovementType.slide, capturing: "required", reflection: "none", initialMove: "optional" },
									movements: [{ direction: moveDirection.up, distance: 1 }],
								},
							],
							["direct"]
						);
						const result = calculateMovesRect(
							piece,
							[3, 3],
							boardSize,
							[],
					...
					test("returns no moves when no enemy is present at landing square", () => {
						const piece = new Piece(
							...
							[
								{
									attributes: {
										type: moveMovementType.slide, capturing: "required",
										reflection: "none",
					...
					test("enemy at landing square blocks the move", () => {
						const piece = new Piece(
							...
							[
								{
									attributes: {
										type: moveMovementType.slide, capturing: "disabled",
										reflection: "none",
										initialMove: "optional"
									},
									movements: [{ direction: moveDirection.up, distance: 1 }],
			...
			test("generates moves in both original and horizontally mirrored direction", () => {
				const piece = new Piece(
					...
					[
						{
							attributes: {
								type: moveMovementType.slide, reflection: moveReflect.horizontal,
								initialMove: "optional",
								capturing: "optional"
							},
			...
			test("generates moves in both original and vertically mirrored direction", () => {
				const piece = new Piece(
					...
					[
						{
							attributes: {
								type: moveMovementType.slide, reflection: moveReflect.vertical,
								initialMove: "optional",
								capturing: "optional"
							},
							movements: [{ direction: moveDirection.upright, distance: 1 }],
					...
					test("returns the landing square with capture when enemy is at landing square", () => {
						const piece = new Piece(
							...
							[
								{
									attributes: {
										type: moveMovementType.jump, capturing: "required",
										reflection: "none",
										initialMove: "optional"
									},
					...
					test("enemy at landing square blocks the jump", () => {
						const piece = new Piece(
							...
							[
								{
									attributes: {
										type: moveMovementType.jump, capturing: "disabled",
										reflection: "none",
										initialMove: "optional"
									},
									movements: [{ direction: moveDirection.up, distance: 2 }],
			...
			test("generates moves in both original and horizontally mirrored direction", () => {
				const piece = new Piece(
					...
					[
						{
							attributes: {
								type: moveMovementType.jump, reflection: moveReflect.horizontal,
								initialMove: "optional",
								capturing: "optional"
							},
			...
			test("generates moves in both original and vertically mirrored direction", () => {
				const piece = new Piece(
					...
					[
						{
							attributes: {
								type: moveMovementType.jump, reflection: moveReflect.vertical,
								initialMove: "optional",
								capturing: "optional"
							},
							movements: [{ direction: moveDirection.upright, distance: 2 }],
	...
	describe("Special Attributes", () => {
		test("On initial move", () => {
			const piece = new Piece(
				...
				[
					{
						attributes: {
							type: moveMovementType.slide, initialMove: "required",
							reflection: "none",
							capturing: "optional"
						},
						movements: [{ direction: moveDirection.up, distance: 2 }],
		...
		test("Team Rotations", () => {
			...
			const upResult = calculateMovesRect(
				piece,
				[3, 3],
				boardSize,
				[],
			...
			const downResult = calculateMovesRect(
				piece,
				[3, 3],
				boardSize,
				[],
